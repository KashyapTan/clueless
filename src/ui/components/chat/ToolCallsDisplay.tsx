    ...
    <div className="tool-calls-container">
      ...
      >
        <div className="tool-header-left">
          {/* Gear Icon */}
          <svg className="tool-icon-gear" viewBox="0 0 16 16" width="14" height="14" fill="currentColor">
          ...
          <span className="tool-header-text">Used {toolCalls.length} tool{toolCalls.length > 1 ? 's' : ''}</span>
        </div>
